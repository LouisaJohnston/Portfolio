...
const DRIFT_PERIODS = [2.6, 3.4, 2.9, 4.0, 3.1]; // seconds for one wander
const DRIFT_X = [5, -4, 2, -6]; // px sideways, relative to the flock
const DRIFT_Y = [11, 7, 13]; // px of rise and fall
