    ...
    return (
        <div>
            <ul className="less-flush">
                <li>Designed a full-stack MERN app using complex authorization routes allowing users to register as either a pet owner or a pet hotel owner</li>
                ...
                <li>Saved user input through a server-side Mongoose database using MongoDB</li>
            </ul>
